...
const std::string BACKGROUND_PATH = "/project/assets/background.png";
const std::string MUSIC_PATH = "/project/assets/background_music.mp3";
const std::string FONT_PATH = "/project/assets/font.ttf";
const std::string ATLAS_PATH = "/project/assets/atlas.png";
